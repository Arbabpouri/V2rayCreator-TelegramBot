...
from modules.enums.enums import (
    UserTypes, 
    CryptoStatus, 
    CryptoPaymentType,
    ConfigProtocol,
        ...
        if (data == "CUSTOM-CHARGE"):
            ...
            if (isinstance(configs, int)):
                ...
                for config in configs:
                    ...
                    await event.edit(Strings.error_text(ResponseCode.CONFIG_DOES_NOT_EXIST), buttons=InlineButtons().BACK_TO_HOME)
                    return
                ...
                if (balance >= price):
                    ...
                    add_config = v2ray.add_new_config(
                        ...
                        protocol=ConfigProtocol.DEFULT.lower(),
                    ...
                    if (isinstance(payment_link_irr, int) or
                        ...
                        if (str(payment_link_irr) in response_error or
                            ...
                            text = Strings.error_text(payment_link_irr)
